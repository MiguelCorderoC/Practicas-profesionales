...
function UnidadView() {
  const unidades = [
    ...
    },
    {
      ...
      descripcion:
        "El caso ha sido remitido a unidad judicial para cobrar la deuda.",
    },
    {
      id: 8,
    ...
    },
    {
      ...
      descripcion:
        "El cliente está en unidad de negociar las condiciones de pago.",
    },
    {
      id: 10,
      nombre: "Cancelado",
      ...
      <main className="pl-52 min-h-screen bg-gray-100 dark:bg-gray-900 dark:text-gray-200">
        <section className="pt-5">
          <article className="flex justify-between items-center">
            <h2 className="text-4xl font-semibold">Unidades</h2>
